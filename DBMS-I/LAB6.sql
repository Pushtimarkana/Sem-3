...
SELECT LOWER('PUSHTI'),UPPER('Pushti');

--3. Display first three characters of your name.
SELECT LEFT('PUSHTI',3);

--4. Display 3rd to 10th character of your name.
SELECT SUBSTRING('PUSHTI MARKANA',3,8);

--5. Write a query to convert ‘abc123efg’ to ‘abcXYZefg’ & ‘abcabcabc’ to ‘ab5ab5ab5’ using REPLACE.
SELECT REPLACE('abc123efg','123','XYZ'),REPLACE('abcabcabc','c','5');

--6. Write a query to display ASCII code for ‘a’,’A’,’z’,’Z’, 0, 9.
SELECT ASCII('a'),ASCII('A'),ASCII('z'),ASCII('Z'),ASCII('0'),ASCII('19')
...
SELECT DATEDIFF(YEAR,'2010-09-14','2012-01-05');
...
SELECT DATEDIFF(YEAR,'2005-05-19',GETDATE()) AS YEAR,DATEDIFF(MONTH,'2005-05-19',GETDATE()) AS MONTH;
...
SELECT DATEDIFF(YEAR,'2005-05-19',GETDATE()) AS YEARS,DATEDIFF(MONTH,'2005-05-19',GETDATE()) AS MONTHS,DATEDIFF(DAY,'2005-05-19',GETDATE()) AS DAYS;